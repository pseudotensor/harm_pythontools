...
def matt_read_test(fname = "jet_lores.hdf5"):
    f = h5py.File(fname, "r")
    #
    # do something
    #
...
def interpolate_stuff_for_matt(doreload=1,no=5468,xmax=100,ymax=100,zmax=500,ncellx=50,ncelly=50,ncellz=250,fname="jet.hdf5"):
    if doreload:
    ...
    print( "Running trilinear interpolation for lrho..." ); sys.stdout.flush()
    lrhoi = np.float32(trilin(lrho,i3d_jet,j3d_jet,k3d_jet))
    print( "Done with trilinear interpolation for lrho..." ); sys.stdout.flush()
    print( "Running trilinear interpolation for rho..." ); sys.stdout.flush()
    rhoi = np.float32(trilin(rho,i3d_jet,j3d_jet,k3d_jet))
    print( "Done with trilinear interpolation for rho..." ); sys.stdout.flush()
    print( "Running trilinear interpolation for ug..." ); sys.stdout.flush()
    ugi = np.float32(trilin(ug,i3d_jet,j3d_jet,k3d_jet))
    print( "Done with trilinear interpolation for ug..." ); sys.stdout.flush()
    print( "Running trilinear interpolation for ug..." ); sys.stdout.flush()
    bsqi = np.float32(trilin(bsq,i3d_jet,j3d_jet,k3d_jet))
    print( "Done with trilinear interpolation for ug..." ); sys.stdout.flush()
    #
    # Magnetic field
    #
    ...
    Bxi = np.float32(trilin(Bxyz[1],i3d_jet,j3d_jet,k3d_jet))
    ...
    Byi = np.float32(trilin(Bxyz[2],i3d_jet,j3d_jet,k3d_jet))
    ...
    Bzi = np.float32(trilin(Bxyz[3],i3d_jet,j3d_jet,k3d_jet))
    print( "Done with trilinear interpolation for Bz..." ); sys.stdout.flush()
    #
    # velocities
    #
    vxyz = prime2cart(uu/uu[0])
    print( "Running trilinear interpolation for vx..." ); sys.stdout.flush()
    vxi = np.float32(trilin(vxyz[1],i3d_jet,j3d_jet,k3d_jet))
    print( "Done with trilinear interpolation for vx..." ); sys.stdout.flush()
    print( "Running trilinear interpolation for vy..." ); sys.stdout.flush()
    vyi = np.float32(trilin(vxyz[2],i3d_jet,j3d_jet,k3d_jet))
    print( "Done with trilinear interpolation for vy..." ); sys.stdout.flush()
    print( "Running trilinear interpolation for vz..." ); sys.stdout.flush()
    vzi = np.float32(trilin(vxyz[3],i3d_jet,j3d_jet,k3d_jet))
    print( "Done with trilinear interpolation for vz..." ); sys.stdout.flush()
    print( "Running trilinear interpolation for gamma..." ); sys.stdout.flush()
    gammai = np.float32(trilin(gamma,i3d_jet,j3d_jet,k3d_jet))
    print( "Done with trilinear interpolation for gamma..." ); sys.stdout.flush()
    #
    dic = {}
    dic["lrho"] = lrhoi
    dic["rho"] = rhoi
    ...
    dic["z"] = zi_jet
    dic["t"] = t
    dic["fieldline_number"] = no
    writehdf5(data_dic=dic,fname=fname)
